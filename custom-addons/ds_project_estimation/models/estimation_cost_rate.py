...
class CostRate(models.Model):
    ...
    currency_usd_id = fields.Many2one('res.currency', default=1) # 2 is USD , string="Currency"
    currency_yen_id = fields.Many2one('res.currency', default=24) # 2 is YEN , string="Currency"
    currency_vnd_id = fields.Many2one('res.currency', default=22) # 2 is VND , string="Currency"
