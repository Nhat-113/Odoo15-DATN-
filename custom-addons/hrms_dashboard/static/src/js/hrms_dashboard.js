odoo.define("hrms_dashboard.DashboardRewrite", function(require) {
    ...
    var HrDashboard = AbstractAction.extend({
        ...
        events: {
            ...
            "click .btn_dashboard_detail": "swap_menu",
        ...
        render_dashboards: async function() {
            var self = this;
            if (this.login_employee) {
                ...
                if (self.is_manager == true) {
                    ...
                    templates = ["ManagerDashboard", ];
                }
                _.each(templates, function(template) {
                    self.$('.employee-right').append(QWeb.render('ManagerDashboard', { widget: self }));
                    self
                        .$(".o_hr_dashboard")
        ...
        swap_menu: function(events) {
            ...
            targetClass = target.className.includes("btn_dashboard_detail") ?
                "employee_dashboard_detail" :
        ...
        //clendar 
        dashboard_today_meeting: function(e) {
            var self = this;
            e.stopPropagation();
            e.preventDefault();
            session.user_has_group("hr.group_hr_user").then(function(has_group) {
        ...
        //in recruiment
        dashboard_in_recruiment: function(e) {
            var self = this;
            e.stopPropagation();
            e.preventDefault();
            session.user_has_group("hr.group_hr_user").then(function(has_group) {
